...
import { publicDemoRouter } from "./modules/demo/demo.routes";
import { publicEventsRouter } from "./modules/events/public-events.routes";
import { publicGoogleReviewsRouter } from "./modules/google-reviews/google-reviews.routes";
import { publicCertificateRouter } from "./modules/certificate/certificate.routes";
...
app.use("/api/v1/demo", publicDemoRouter);
app.use("/api/v1/events", publicEventsRouter);
app.use("/api/v1/google-reviews", publicGoogleReviewsRouter);
